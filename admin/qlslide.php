            ...
            <div class="modal-body">
                <form id="editForm">
                    ...
                    <div class="form-group">
                        <label for="editName">Tên Slide:</label>
...
<script>
    ...
    var photo = $('#editPhoto').val();
        ...
        $.ajax({
            url: '../admin/action/slide_controller.php',
            method: 'post',
            data: {
                action: 'edit',
                id: id,
...
<div class="modal" id="addModal">
    <div class="modal-dialog">
        <div class="modal-content">
            <!-- Modal Header -->
            <div class="modal-header">
                <h4 class="modal-title">Thêm SlideShow</h4>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            <!-- Modal Body -->
            <div class="modal-body">
                <form id="addForm" enctype="multipart/form-data">
                    <div class="form-group">
                        <label for="newName">Tên SlideShow:</label>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                <button type="button" class="btn btn-primary" id="addCategoryBtn">Thêm SlideShow</button>
            </div>
        </div>
    </div>
</div>
...
$(document).ready(function() {
    ...
    $('.delete-btn').click(function() {
        ...
        var id = $(this).data('id');
        if (confirm('Bạn có chắc chắn muốn xóa SlideShow này không?')) {
            $.ajax({
                url: '../admin/action/slide_controller.php',
                method: 'post',
                data: {
